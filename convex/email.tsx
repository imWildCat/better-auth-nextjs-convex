...
export const sendEmailVerification = async (
  ...
  console.log("Sending email verification email to", to, url);
  return;
...
export const sendOTPVerification = async (
  ...
  console.log("Sending OTP verification email to", to, code);
  return;
  await resend.sendEmail(ctx, {
    from: "Test <onboarding@boboddy.business>",
    to,
...
export const sendMagicLink = async (
  ...
  console.log("Sending magic link email to", to, url);
  return;
  await resend.sendEmail(ctx, {
    from: "Test <onboarding@boboddy.business>",
    to,
